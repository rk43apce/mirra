    ...
    <main>
        ...
        <section class="slice slice-lg pb-150 bg-gradient-primary">
            <div class="container pt-lg">
                <div class="row">
                    <div class="col-lg-7">
                        <h1 class="display-4 text-white lh-110">Utilization Management</h1>
                        <p class="lead mb-4 text-white mt-4">On-point care at minimised overall cost</p>
                        <div class="mt-5">
        ...
        <section class="slice slice-lg delimiter-bottom">
            ...
            <div class="container">
                <div class="row row-grid">
                    ...
                    <div class="col-lg-8">
                        <p class="lead lh-180">
                         Mirra crafts the most efficient method of processing authorizations referrals for you and your practice.
                        </p>
                    </div>
                </div>
                <div class="row row-grid">
                ...
                <div class="row row-grid">
                    <div class="col-lg-4">
                        <h4>Easy Referral Management</h4>
                    </div>
                    <div class="col-lg-8">
                        <p class="lead lh-180">
                         Mirra’s Utilization Management services also allow you to refer an authorization to a referral coordinator easily.
                        </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-12 text-center">
                       ...
                       <h3 class="heading h2">Mirra’s utilization management services drop the total turnaround time for processing an authorization by up to 80%.</h3>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-12 text-center">
                       ...
                       <h3 class="heading h2">Curb healthcare costs effectively</h3>
                       <div class=" mt-3">
                        <p class="lead"> Mirra employs professionally qualified personnel who can help you not just draw up a great UM plan, but also run it with the diligence that is required to make such a project a success!</p>
                        </div>
