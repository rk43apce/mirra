    ...
    <main>
        <section class="slice bg-gradient-primary pb-250">
            <div class="container pt-xl">
                <div class="row">
                    <div class="col-lg-5">
                        <h1 class="text-white"><?php echo (Session::exists('errorMsg'))? Session::get('errorMsg') : '' ?></h1>                                               
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-lg-6">
                        ...
                        <form class="mt-5" action = './process/save-contact.php' method= "post">
