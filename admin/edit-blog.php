...
if (Input::exists('post')) {
    ...
    if ($blog->updateBlog($blogData, $blogId)) {
        Session::put('errorMsg', 'Blog Successfully updated!');
        Redirect::to('manageBlog.php');
        exit();
    } else {
        Session::put('errorMsg', 'Fail to update. Please try again!');
    }
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <input name="category" class="form-control" value="<?php echo $category; ?>">
                                        </div>
                                    </div>
                                </div>                        
                                <!-- Description -->
