        ...
        <nav class="navbar navbar-main navbar-expand-lg navbar-sticky navbar-transparent navbar-dark bg-dark" id="navbar-main">
            <div class="container">
                <a class="navbar-brand mr-lg-5" href="./index.html">
                    <img alt="Image placeholder" src="./assets/img/mirra/mirra-logo-reverse.svg" style="height: 70px;">
                </a>
...
<!--                        <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                        ...
                        <li class="nav-item mr-0">
                            <a href="register.html" target="_blank" class="nav-link d-lg-none">Login</a>
                            <a href="register.html" class="btn btn-sm btn-white btn-circle btn-icon d-none d-lg-inline-flex">
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-md-5 mb-4 mb-md-0">
                                <span class="h2 mb-0 text-white d-block">Morning Pariksith</span>
                        ...
                        <!-- Account navigation -->
                        <div class="d-flex">
                            <a href="profile-public.html" class="btn btn-icon btn-group-nav shadow btn-secondary">
                                <span class="btn-inner--icon"><i class="fas fa-user"></i></span>
                                <span class="btn-inner--text d-none d-md-inline-block">My Profile</span>
                            </a>
							<a href="connections.html" class="btn btn-icon btn-group-nav shadow btn-secondary">
                                <span class="btn-inner--text d-none d-md-inline-block">My Connections</span>
                            </a>
                            <div class="btn-group btn-group-nav shadow ml-auto" role="group" aria-label="Basic example">
                                <div class="btn-group" role="group">
                                    <button href="overview.html" id="btn-group-boards" type="button" class="btn btn-secondary btn-icon">
										<a href="overview.html">
                                        <span class="btn-inner--icon"><i class="fas fa-chart-line"></i></span>
                                        <span class="btn-inner--text d-none d-sm-inline-block">My Dashboard</span>
										</a>
                                    </button>
                                </div>
                                <div class="btn-group" role="group">
                                    <button href="create-profile.html" id="btn-group-settings" type="button" class="btn btn-secondary btn-icon" >
            ...
            <div class="container">
                ...
                <div class="mb-5">
                    ...
                    <i class="fas fa-credit-card"></i>
                                        ...
                                        <div class="pl-4">
                                            <h5 class="mb-1 text-white">Compliance Quotient</h5>
                                            <span class=" text-white">Your current score is 71%</span><br>
											<small class="text-white">8 Audits Pending</small><br>
											<a class="btn btn-sm btn-white mt-3">Continue</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <i class="fas fa-file-alt"></i>
                                        ...
                                        <div class="pl-4">
                                            <h5 class="mb-1 text-white">Quality Score</h5>
                                            <span class=" text-white">Your current score is 5.6</span><br>
											<small class="text-white">5 Tests Pending</small><br>
											<a class="btn btn-sm btn-white mt-3">Continue</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-stats bg-gradient-success shadow-success border-0 mb-4">
                    ...
                    <i class="fas fa-file-alt"></i>
                                        ...
                                        <div class="pl-4">
                                            <h5 class="mb-1 text-white">Edutainment</h5>
                                            <span class=" text-white">5 courses completed</span><br>
											<small class="text-white">5 courses Pending</small><br>
											<a class="btn btn-sm btn-white mt-3">Continue</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="page-inner-header mb-4">
                    <h5 class="mb-1">Connection Requests</h5>
                ...
                <div class="card-deck flex-column flex-lg-row mb-5">
                    <div class="card shadow--hover mb-4 mb-lg-0">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar avatar-lg rounded-circle shadow">
                                    <img alt="Image placeholder" src="assets/img/prv/team-4-800x800.jpg">
                                </a>
                                <div class="avatar-content">
                                    <h6 class="mb-0">Dr. Caradona</h6>
                                    <small class="d-block text-muted font-weight-bold">caradona@gmail.com</small>
						...
						<div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
									<p>Hi Dr. Singh, I would like to add you to my professional network.</p>
								</div>
							</div>
						</div>
                    ...
                    <div class="card shadow--hover mb-4 mb-lg-0">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar avatar-lg rounded-circle shadow">
                                    <img alt="Image placeholder" src="assets/img/prv/team-3-800x800.jpg">
                                </a>
                                <div class="avatar-content">
                                    <h6 class="mb-0">Dr. Emandi</h6>
                                    <small class="d-block text-muted font-weight-bold">emandi@gmail.com</small>
                                    <span class="text-muted"><i class="fas fa-clock mr-2"></i>10:30 AM</span> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card shadow--hover mb-4 mb-lg-0">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <a href="#" class="avatar avatar-lg rounded-circle shadow">
                                    <img alt="Image placeholder" src="assets/img/prv/team-2-800x800.jpg">
                                </a>
                                <div class="avatar-content">
                                    <h6 class="mb-0">Dr. Adam</h6>
                                    <small class="d-block text-muted font-weight-bold">adam@gmail.com</small>
                                    <span class="text-muted"><i class="fas fa-clock mr-2"></i>10:30 AM</span> 
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-flush mb-0 align-items-center">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="tbl-messages-check-1">
                                            <label class="custom-control-label" for="tbl-messages-check-1"></label>
                                        </div>
                                    </td>
                                    <td style="width: 40%;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-0 text-sm">Dr. Vennamaneni</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-md badge-pill badge-info mr-2">Compliance</span>
                                            <p class="mb-0 text-muted text-limit text-sm">Take the final steps to finish setting up your phone by downloading these official Mirra apps.</p>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="#"><i class="fas fa-user text-muted"></i>See profile</a>
                                                <a class="dropdown-item" href="#"><i class="fas fa-envelope text-muted"></i>Send message</a>
                                                <a class="dropdown-item" href="#"><i class="fas fa-trash-alt text-muted"></i>Remove</a> 
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="tbl-messages-check-2">
                                            <label class="custom-control-label" for="tbl-messages-check-2"></label>
                                        </div>
                                    </td>
                                    <td style="width: 40%;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-0 text-sm">Dr. Adam</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-md badge-pill badge-warning mr-2">Laravel</span>
                                            <p class="mb-0 text-muted text-limit text-sm">Take the final steps to finish setting up your phone by downloading these official Mirra apps.</p>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="tbl-messages-check-3">
                                            <label class="custom-control-label" for="tbl-messages-check-3"></label>
                                        </div>
                                    </td>
                                    <td style="width: 40%;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-0 text-sm">Dr. Emandi</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="table-td-text">
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-md badge-pill badge-danger mr-2">Photoshop</span>
                                            <p class="mb-0 text-muted text-limit text-sm">Take the final steps to finish setting up your phone by downloading these official Mirra apps.</p>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="tbl-messages-check-4">
                                            <label class="custom-control-label" for="tbl-messages-check-4"></label>
                                        </div>
                                    </td>
                                    <td style="width: 40%;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mb-0 text-sm">Dr. Caradona</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-md badge-pill badge-success mr-2">Event</span>
                                            <p class="mb-0 text-muted text-limit text-sm">Take the final steps to finish setting up your phone by downloading these official Mirra apps.</p>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="tbl-messages-check-5">
                                            <label class="custom-control-label" for="tbl-messages-check-5"></label>
                                        </div>
                                    </td>
                                    <td style="width: 40%;">
                                        <div class="media align-items-center">
                                            <a href="#" class="avatar rounded-circle mr-3">
                                                <img alt="Image placeholder" src="assets/img/prv/team-5-800x800.jpg">
                                            </a>
                                            <div class="media-body">
                                                <h6 class="mb-0 text-sm">Dr. Mughni</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-md badge-pill badge-warning mr-2">Update</span>
                                            <p class="mb-0 text-muted text-limit text-sm">Take the final steps to finish setting up your phone by downloading these official Mirra apps.</p>
                                        </div>
                                    </td>
                                    <td>
                    ...
                    <div class="card shadow--hover mb-4 mb-lg-0">
                        ...
                        <div class="list-group list-group-flush mb-3">
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <span class="icon icon-shape bg-lighter rounded-circle text-warning"><i class="fas fa-envelope"></i></span>
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification">Mail sent to <span class="text-warning">Alex Michael</span>
                                        </p>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <span class="icon icon-shape bg-lighter rounded-circle text-info"><i class="fas fa-thumbs-up"></i></span>
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification">You like a comment from <span class="text-info">Sandra Wayne</span>
                                        </p>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <span class="icon icon-shape bg-lighter rounded-circle text-success"><i class="fas fa-check"></i></span>
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification">Task completed: <span class="text-success">Website redesign</span>
                                        </p>
                    ...
                    <div class="card shadow--hover mb-4 mb-lg-0">
                        ...
                        <div class="list-group list-group-flush mb-3">
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <img alt="Image placeholder" src="assets/img/prv/thumb-1.jpg" class="avatar">
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification"><span class="text-info">@alexa.smith</span> commented on your post</p>
                                        <small class="text-muted">3 hrs ago</small>
                                    </div>
                                </div>
                            </a>
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <img alt="Image placeholder" src="assets/img/prv/thumb-2.jpg" class="avatar">
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification">New message from <span class="text-info">@michael</span>
                                        </p>
                                        <small class="text-muted">5 hrs ago</small>
                                    </div>
                                </div>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="notification">New task added for you by <span class="text-info">@tom.cruise</span>
                                        </p>
                                        <small class="text-muted">6 hrs ago</small>
                                    </div>
                                </div>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="notification">New message from <span class="text-info">@will.smith</span>
                                        </p>
                                        <small class="text-muted">3 hrs ago</small>
                                    </div>
                                </div>
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-0 py-2">
                                <div class="list-group-content d-flex align-items-center">
                                    <div>
                                        <img alt="Image placeholder" src="assets/img/prv/team-3-800x800.jpg" class="avatar">
                                    </div>
                                    <div class="ml-3">
                                        <p class="notification">New message from <span class="text-info">@will.smith</span>
                                        </p>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-8 text-center">
                        <h3 class="font-weight-400 text-white">Invite a friend and <span class="font-weight-700">earn free credits</span></h3>
                        <div class="mt-5">
                            <a href="" target="_blank" class="btn btn-white btn-circle btn-translate--hover px-4">Invite now</a>
                            <a href="mailto:support@webpixels.io" class="btn btn-link text-white">Have an issue?</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row pt-md">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <a href="index.html">
                        <img src="assets/img/mirra/mirra-logo.png" alt="Footer logo" style="height: 90px;">
                    </a>
                    <p class="text-sm">Mirra improves the quality of healthcare by improving efficiency and creating inter-operability by providing resources with a holistic and comprehensive approach touching all aspects of healthcare integrating The Payor, The Patient and The Provider.</p>
                </div>
            ...
            <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                <div class="col-md-6">
                    <div class="copyright text-sm font-weight-bold text-center text-md-left">
                        &copy; 2018 <a href="https://webpixels.io/" class="font-weight-bold" target="_blank">Mirra Healthcare</a>. All rights reserved.
                    </div>
                </div>
                <div class="col-md-6">
